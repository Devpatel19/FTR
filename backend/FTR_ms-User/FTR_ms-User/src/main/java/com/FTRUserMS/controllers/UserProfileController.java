...
import com.FTRUserMS.Entity.UserLogin;
...
public class UserProfileController {
	...
	@PostMapping("/login")
	public ResponseEntity<UserLogin> login(@RequestBody @Valid LoginDTO logindto) throws CustomException{
		String response = "Success:{\n message:\"" + loginsuccess+"\"\n}";
		UserLogin userLogin = new UserLogin(response);
